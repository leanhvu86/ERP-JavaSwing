...
public class MainTheme extends JFrame implements Runnable {
    ...
    private void initView() {
        ...
        menuTChu.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, "Thống kê!!");
                try {
                    NSu = false;
        ...
        menuNSu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, "Nhân sự!!");
                try {
                    DGia = false;
                    danhGia.setVisible(DGia);
                } catch (Exception e) {
        ...
        menuDGia.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, "Đánh giá!!");
                try {
                    NSu = false;
                    nhanSu.setVisible(NSu);
                } catch (Exception e) {
        ...
        menuDtao.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, "Dao tạo!!");
                try {
                    NSu = false;
                    nhanSu.setVisible(NSu);
                } catch (Exception e) {
        ...
        menuTDung.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, "Tuyen Dụng!!");
                try {
                    NSu = false;
                    nhanSu.setVisible(NSu);
                } catch (Exception e) {
    ...
    public void showTheme() {
        ...
        if (LoggedRole.getLoggedRole().equals("Supervisor") || LoggedRole.getLoggedRole().equals("User")) {
            menuTDung.setEnabled(false);
        } else {
